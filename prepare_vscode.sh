...
if [[ "${VSCODE_QUALITY}" == "insider" ]]; then
  setpath "product" "nameShort" "Horus - Insiders"
  setpath "product" "nameLong" "Horus - Insiders"
  setpath "product" "applicationName" "horus-insiders"
  setpath "product" "dataFolderName" ".horus-insiders"
  setpath "product" "linuxIconName" "horus-insiders"
  setpath "product" "quality" "insider"
  setpath "product" "urlProtocol" "horus-insiders"
  setpath "product" "serverApplicationName" "horus-server-insiders"
  setpath "product" "serverDataFolderName" ".horus-server-insiders"
  setpath "product" "darwinBundleIdentifier" "com.horus.HorusInsiders"
  setpath "product" "win32AppUserModelId" "Horus.HorusInsiders"
  setpath "product" "win32DirName" "Horus Insiders"
  setpath "product" "win32MutexName" "horusinsiders"
  setpath "product" "win32NameVersion" "Horus Insiders"
  setpath "product" "win32RegValueName" "HorusInsiders"
  setpath "product" "win32ShellNameShort" "Horus Insiders"
  ...
  setpath "product" "tunnelApplicationName" "horus-tunnel-insiders"
  setpath "product" "win32TunnelServiceMutex" "horusinsiders-tunnelservice"
  setpath "product" "win32TunnelMutex" "horusinsiders-tunnel"
else
  setpath "product" "nameShort" "Horus"
  setpath "product" "nameLong" "Horus"
  setpath "product" "applicationName" "horus"
  setpath "product" "linuxIconName" "horus"
  setpath "product" "quality" "stable"
  setpath "product" "urlProtocol" "horus"
  setpath "product" "serverApplicationName" "horus-server"
  setpath "product" "serverDataFolderName" ".horus-server"
  setpath "product" "darwinBundleIdentifier" "com.horus"
  setpath "product" "win32AppUserModelId" "Horus.Horus"
  setpath "product" "win32DirName" "Horus"
  setpath "product" "win32MutexName" "horus"
  setpath "product" "win32NameVersion" "Horus"
  setpath "product" "win32RegValueName" "Horus"
  setpath "product" "win32ShellNameShort" "Horus"
  ...
  setpath "product" "tunnelApplicationName" "horus-tunnel"
  setpath "product" "win32TunnelServiceMutex" "horus-tunnelservice"
  setpath "product" "win32TunnelMutex" "horus-tunnel"
fi
